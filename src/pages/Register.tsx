...
import { UserPlus, Mail, Lock, User, AlertCircle, Sparkles, Chrome, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-slate-50 px-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10">
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand-500/10 blur-[120px] rounded-full"></div>
      ...
      >
        <div className="bg-white rounded-[40px] shadow-2xl shadow-slate-200 border border-slate-100 p-10 relative">
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl font-display font-bold tracking-tight">Join CreateSphere</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-300 group-focus-within:text-brand-500 transition-colors" />
                  <input 
                    type="text" 
                    required
                    value={name}
              ...
              >
                {loading ? "Creating Account..." : "Start Creating Now"}
